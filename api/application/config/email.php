...
| mailtype           text                text or html                Type of mail. If you send HTML email you must send it as a complete web page.
...
$config['mailpath']         = '';
$config['smtp_host']        = 'packinstitutecom.ipage.com';
$config['smtp_user']        = 'management@packinstitute.com';
$config['smtp_pass']        = 'P@ckUn1v3rsity!';
